...
describe('User', () => {
  ...
  it('should be an instance os User', () => {
    const gladys = new User();
    expect(gladys).to.be.an.instanceOf(User)
  });
  ...
  it('should return a users first name only', () => {
    ...
    const gladys = new User(userRepo);
    expect(gladys.returnFirstName()).to.equal('Gladys')
  })
});
